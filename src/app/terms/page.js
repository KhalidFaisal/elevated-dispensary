      ...
      <div className="pt-24 pb-16 min-h-screen">
        ...
        <div className="glass-card p-8 md:p-12 space-y-8 text-pc-muted">
          ...
          <section>
            ...
            <p className="leading-relaxed">Elevated and its affiliates are not responsible for any legal action, confiscation, or health issues resulting from the use or purchase of our products. Use at your own risk. By purchasing from our store, you agree to assume full responsibility for all parts pertaining to your purchase.</p>
          </section>
        </div>
      </div>
    </div>
